import insertionSort, { ISAnimationType } from './insertionSort';

const animateInsertionSort = async (mainArray: number[], ANIMATION_SPEED: number): Promise<number> => {
  const animation: ISAnimationType[] = [];
  insertionSort(mainArray, animation);
